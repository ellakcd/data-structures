...
def unique_houses(filename):
    ...
    """
    file = open(filename)
    houses = {line.strip().split("|")[2] for line in file if line.strip().split("|")[2] != ""}
    return houses
...
def sort_by_cohort(filename):
    ...
    """
    file1 = open(filename)
    winter_16 = [line.split("|")[0] + " " + line.split("|")[1] for line in file1 if line.strip().split("|")[-1] == "Winter 2016"]
    file1 = open(filename)
    spring_16 = [line.split("|")[0] + " " + line.split("|")[1] for line in file1 if line.strip().split("|")[-1] == "Spring 2016"]
    file1 = open(filename)
    summer_16 = [line.split("|")[0] + " " + line.split("|")[1] for line in file1 if line.strip().split("|")[-1] == "Summer 2016"]
    file1 = open(filename)
    fall_15 = [line.split("|")[0] + " " + line.split("|")[1] for line in file1 if line.strip().split("|")[-1] == "Fall 2015"]
    file1 = open(filename)
    ghosts = [line.split("|")[0] + " " + line.split("|")[1] for line in file1 if line.strip().split("|")[-1] == "G"]
...
def all_students_tuple_list(filename):
    ...
    for line in file1:
        ...
        if student_data[-1] != "G" and student_data[-1] != "I":
            student_data_tuple = (student_data[0] + " " + student_data[1], student_data[2], student_data[3], student_data[4])
            student_list.append(student_data_tuple)
